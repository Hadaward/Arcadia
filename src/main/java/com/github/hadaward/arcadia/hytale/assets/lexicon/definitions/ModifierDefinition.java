...
public final class ModifierDefinition extends LexiconWordDefinition implements JsonAssetWithMap<String, DefaultAssetMap<String, ModifierDefinition>> {
    public static final AssetCodec<String, ModifierDefinition> CODEC =
        AssetBuilderCodec
            .builder(
